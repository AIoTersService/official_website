      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="space-y-4">
            <div className="inline-block rounded-lg bg-gradient-to-r from-[#2B3A67]/20 via-[#8B5A8C]/20 to-[#E17B47]/20 px-3 py-1 text-sm">
              May, 2025
            </div>
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              <Button
                variant="outline"
                className="inline-flex h-10 items-center justify-center rounded-md border border-[#2B3A67] bg-white px-8 text-sm font-medium text-[#2B3A67] shadow-sm transition-colors hover:bg-[#2B3A67]/5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#2B3A67] disabled:pointer-events-none disabled:opacity-50 dark:border-[#8B5A8C] dark:bg-gray-950 dark:text-[#8B5A8C] dark:hover:bg-[#8B5A8C]/10"
              >
                Contact Us
              </Button>
            </div>
